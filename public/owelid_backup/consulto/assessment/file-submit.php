...
if (isset($_POST['submit'])){
	...
	{
		echo "<div class='alert alert-success'>Successfully updated! <a href='view-assessment.php'>View Assessment</a></div>";
	}
	else
	{
		...
		<div class="col-lg-4">
			<div class="form-group">
				...
				<select class="form-control" name="office" data-validation="required">
					<option value=""></option>
					<option value="Dhaka" <?php if($row_query_assessment['office']=='Dhaka') echo "selected"; ?>>Dhaka Office</option>
					<option value="Chittagong"<?php if($row_query_assessment['office']=='Chittagong') echo "selected"; ?>>Chittagong Office</option>
					<option value="Jessore"<?php if($row_query_assessment['office']=='Jessore') echo "selected"; ?>>Jessore Office</option>
				</select>
			</div>
		</div>
		<div class="col-lg-4">
			<div class="form-group">
				...
				<select class="form-control" name="counselor" disabled>
