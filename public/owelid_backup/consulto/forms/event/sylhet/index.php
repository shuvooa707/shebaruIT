...
<head>
  ...
  <!-- Site Properties -->
  <title>Event in Sylhet - Bangladesh Malaysia Study Centre Ltd.</title>
    ...
    <div class="table-container">
      <table id="example" class="table" style="width:100%">
        ...
        <tbody>
            <?php
            $count = 0;
            $sql = "SELECT * FROM online_registration WHERE office='Dhaka' AND type='Event' AND location='Sylhet'";
