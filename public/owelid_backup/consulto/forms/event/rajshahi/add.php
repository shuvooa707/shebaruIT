...
if(isset($_REQUEST['submit'])){
    ...
    $query = "INSERT INTO online_registration (office, type, location, name, program, subject, mobile, email, created_at) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');";
    $sql = sprintf($query,$office,$type,$location,$name,$program,$subject,$mobile,$email,date("Y-m-d H:i:s"));
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        if($email != ''){ 
            ...
            <address>
                House # 66 (3rd Floor)<br>
                O.R. Nizam Road R/A, Road # 6, (Near GEC)<br>
                Chittagong, Bangladesh.<br>
                Phone : +88-031-2551114
            </address>
            </body>
            </html>
            ";
        ...
        die("Error: " . mysqli_error($conn)."<br>Please try again.<br>It will be appritiable if you can send us the screenshot to the following email address. <a href='mailto:bmsclsalahuddin@gmail.com'>bmsclsalahuddin@gmail.com</a>");
    }
}
?>
...
<head>
    ...
    <!-- Site Properties -->
    <title>Event in Rajshahi (Study in Malaysia) - Bangladesh Malaysia Study Centre Ltd.</title>
            ...
            <div class="columns is-centered">
                <div class="column is-half">
                    ...
                    if(isset($_REQUEST['success']))
                    {
                        ...
                        <p>We are very excited to know more about you. For urgent queries you can contact us any time at <a href="mailto:info@bmscl.com">info@bmscl.com</a> or visit our office at below address.</p><br>
                        <h3 class="is-size-4">Head Office</h3>
                        <address>
                            ROOM 511 (5th Floor), RH HOME CENTER<br>
                            74/B/1 Green Road<br>
                            (Near University of Asia Pacific / Green Super Market)<br>
                        ...
                        <h3 class="is-size-4">Chittagong Office</h3>
                        <address>
                            House # 66 (3rd Floor)<br>
                            O.R. Nizam Road R/A, Road # 6, (Near GEC)<br>
                            Chittagong, Bangladesh.<br>
