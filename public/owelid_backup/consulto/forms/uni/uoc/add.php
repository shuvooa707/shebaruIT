...
if(isset($_REQUEST['submit'])){
    ...
    if (mysqli_query($conn, $sql)) {
        //send email
        if($email != ''){ 
            $mail_subject = "Registration Confirmed for University of Cyberjaya.";
            $message = "
            <html>
            <head>
            ...
            <div class="container">
                <div class="columns">
                    <div class="column is-two-thirds">
                        ...
                        <img src="../img/UOC-Logo.png" alt="UOC Logo" style="width: 400px; max-width: 100%">
                    </div>
                    <div class="column">
                        <img src="../img/uoc.jpeg">
                    </div>
                </div>
            </div>
        </div>
