...
<head>
  ...
  <!-- Site Properties -->
  <title>UTM Registration Form - Bangladesh Malaysia Study Centre Ltd.</title>
    ...
    <div class="table-container">
      <table id="example" class="table" style="width:100%">
        ...
        <tbody>
            <?php
            $count = 0;
            $sql = "SELECT * FROM online_registration WHERE office='Dhaka' AND type='University' AND location='UTM'";
