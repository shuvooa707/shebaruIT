...
if(isset($_REQUEST['submit'])){
    ...
    if (mysqli_query($conn, $sql)) {
        //send email
        if($email != ''){ 
            $mail_subject = "Registration Confirmed for UTM.";
            $message = "
            <html>
            <head>
            ...
            <div class="container">
                <div class="columns">
                    <div class="column is-two-thirds">
                        ...
                        <img src="../img/logo-utm.png" alt="UTM Logo" style="width: 400px; max-width: 100%">
                    </div>
                    <div class="column">
                        <img src="../img/utm-university.jpg" alt="UTM campus">
                    </div>
                </div>
            </div>
        </div>
