...
if(isset($_REQUEST['submit'])){
    ...
    if (mysqli_query($conn, $sql)) {
        //send email
        if($email != ''){ 
            $mail_subject = "Registration Confirmed for APU University.";
            $message = "
            <html>
            <head>
            ...
            <div class="container">
                <div class="columns">
                    <div class="column is-two-thirds">
                        ...
                        <img src="../img/logo-apu.png" alt="APU Logo" style="width: 400px; max-width: 100%">
                    </div>
                    <div class="column">
                        <img src="../img/apu-university.jpg" alt="APU University">
                    </div>
                </div>
            </div>
        </div>
