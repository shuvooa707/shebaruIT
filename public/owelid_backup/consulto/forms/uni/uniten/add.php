...
if(isset($_REQUEST['submit'])){
    ...
    $query = "INSERT INTO online_registration (office, type, location, name, program, subject, certificate, result, passport, ielts, mobile, email, created_at) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %u, %g, '%s', '%s', '%s');";
    $sql = sprintf($query,$office,$type,$location,$name,$program,$subject,$certificate,$result,$passport,$ielts,$mobile,$email,date("Y-m-d H:i:s"));

    if (mysqli_query($conn, $sql)) {
        //send email
        if($email != ''){ 
            $mail_subject = "Registration Confirmed for Universiti Tenaga Nasional.";
            $message = "
            <html>
            <head>
            ...
            <div class="container">
                <div class="columns">
                    <div class="column is-two-thirds">
                        ...
                        <h2 class="subtitle">Eligibility Assessment & Entrance Scholarship Form</h2>
                        <img src="../img/logo-uniten.png" alt="UCSI Logo" style="height: 200px; max-width: 100%">
                    </div>
                    <div class="column">
                        <img src="../img/uniten.jpeg" alt="Universiti Tenaga Nasional">
                    </div>
                </div>
            </div>
        </div>
