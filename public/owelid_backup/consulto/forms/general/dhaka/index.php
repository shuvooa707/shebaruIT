...
<head>
  ...
  <!-- Site Properties -->
  <title>General Form Dhaka - Bangladesh Malaysia Study Centre Ltd.</title>
...
<?php if(isset($_SESSION["pass"]) && $_SESSION['pass'] == $passcode){ ?>
  ...
  <section class="hero is-light">
    <div class="hero-body">
      <div class="container">
        <h1 class="title">
            General Registration Form Dhaka
        </h1>
        <h2 class="subtitle">
    ...
    <div class="table-container">
      <table id="example" class="table" style="width:100%">
        ...
        <tbody>
            <?php
            $count = 0;
            $sql = "SELECT * FROM online_registration WHERE office='Dhaka' AND type='General'";
