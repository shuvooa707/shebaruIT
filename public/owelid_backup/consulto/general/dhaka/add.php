...
if(isset($_REQUEST['submit'])){
    ...
    $query = "INSERT INTO online_registration (office, type, name, program, subject, certificate, result, passport, ielts, mobile, email, created_at) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', %u, %g, '%s', '%s', '%s');";
    $sql = sprintf($query,$office,$type,$name,$program,$subject,$certificate,$result,$passport,$ielts,$mobile,$email,date("Y-m-d H:i:s"));
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        if($email != ''){ 
            ...
            <address>
                Suite: E4 (4th Floor) , BTi Central Plaza,<br>
                95 Green Road, Farmgate, Dhaka – 1215, Bangladesh.<br>
                Phone : +8802-9114111
            </address>
            </body>
            </html>
...
<head>
    ...
    <meta property="og:url"          content="http://bmscl.com.bd/admin/forms/general/dhaka/add.php" />
    <meta property="og:type"         content="website" />
    <meta property="og:title"        content="Malaysia Education Fair 2019" />
    <meta property="og:description"  content="Education expo 2019 hosted by Bangladesh Malaysia Study Centre Ltd. The location is Dhaka (KIB Convention Hall) and Chittagong (Hotel Peninsula)." />
    <meta property="og:image"        content="http://bmscl.com.bd/admin/forms/general/img/general-form.jpeg" />
    <!-- Site Properties -->
    <title>Education Expo -2019 Bangladesh Malaysia Study Centre Ltd.</title>
                        ...
                        <div class="field">
                            ...
                            <div class="columns is-desktop is-gapless">
                                <div class="column">
                                    ...
                                    <div class="control">
                                        <input class="is-checkradio" id="exampleRadioInline3" type="radio" name="program" value="School-Level">
                                        <label for="exampleRadioInline3">School-Level</label>
                                    </div>
                                    </div>
                                <div class="column">
                                    <div class="control">
